...
object RecipeFixture {
    val espresso: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("2dd641d1-b628-46b8-b3db-54b2fb409af2"),
    ...
    val ristretto: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("9b74c4a3-c989-447e-8018-2d5aade22ef8"),
    ...
    val lungo: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("80c62d5f-522d-457e-97ef-f0246a42514c"),
    ...
    val americano: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("0da3afe6-d794-49a7-9502-eae556c7af72"),
    ...
    val longBlack: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("f3384644-a249-49fe-b104-349277015ea1"),
    ...
    val latte: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("ea54c297-048a-45f9-be19-7566745d286f"),
    ...
    val cappuccino: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("9cff2ba3-0147-432c-b92d-6dba3fe290a4"),
    ...
    val flatWhite: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("67a94fb4-66ef-4e06-86a5-c330773cec69"),
    ...
    val doubleEspresso: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("9a0ce96f-e5b3-417a-90e3-520d176a2d52"),
    ...
    val cortado: Recipe
        get() =
            Recipe(
                id = Recipe.Id.from("a213f3cc-a5ff-4ab8-b44e-d00a07db2cdc"),
